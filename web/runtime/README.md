...
differently licensed grammar C sources. `../NOTICE.md` inventories this
directory alongside the other vendored helix content (`queries/`) via a
pointer paragraph.

## Known gaps in the browser

The tutorial was written for helix in a terminal, and the "do not edit"
rule above means it cannot be annotated for the browser. A walk of all 60
